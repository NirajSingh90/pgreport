...
def find_cpu_info(info):
    ...
    #d4['number of cpu'] = p.stdout.read()
    l = []
...
#        speed["Timing cached reads"] = a[0]
#        speed["Timing buffered disk reads"] = b[0]
    return speed
...
f = open("os.conf","w")
print "#Finding os configuration....."
print "#writing to os.conf...."
f.write("-"*70+"\n")
f.write(""*30+"OS Configurations"+"\n")
f.write("-"*70+"\n\n")

#ram info
print "#Exctrating Memory Information information...."
for k in d1:
...
print "#Exctracting kernel information...."
f.write("-"*70+"\n")
...
print("#Exctrating OS information.....")
f.write("-"*70+"\n")
f.write("CPU info"+"\n")
f.write("-"*70+"\n\n")
for k in d4:
...
print "#Finding RAID information...."
f.write("-"*70+"\n")
f.write("RAID info"+"\n")
f.write("-"*70+"\n\n")
for k in d5:
...
print "#finding disk and partitions information...."
f.write("-"*70+"\n")
...
print "#Finding file system information....."
f.write("-"*70+"\n")
...
print "#find scheduler information ....."
d = tune_scheduler()
