...
f = open("os.conf","w")
f.write("-"*30+"OS CONFIGURATIONS"+"-"*27+"\n\n")
#f.write(""*30+"OS Configurations"+"\n")
#f.write("\n\n")

#ram info
for k in d1:
    str1 = "%s  :  %s"%(str(k).ljust(30),str(d1[k]))
    f.write(str1)
f.write("\n")
f.write("-"*23+"MEMORY INFO(All values in KB)"+"-"*24+"\n\n")
...
f.write("\n")
f.write("-"*30+"KERNEL RESOURCES"+"-"*33+"\n\n")
...
f.write("\n")
f.write("-"*30+"DISKS AND PARTITIONS"+"-"*30+"\n\n")
...
f.write("\n")
f.write("-"*29+"FILE SYSTEM INFORMATION"+"-"*28+"\n\n")
...
f = open("os.conf","a")
f.write("\n")
f.write("-"*30+"SCHEDULER INFORMATION"+"-"*29+"\n")
