...
def get_default_val():
    ...
    f.close()
    print "#getting current value os work memory"
    return k[0][0],k[0][1]
...
def get_shared_mem():
    ...
    file = f.read()
    f.close()
    print "#Exctracting recommeded shared_buffer value from shared_memory"
...
#    print(k)
    ...
    print "#Calculating Recommended value for work memory"
    ...
    while True:
        ...
        if cnt == 4:
            work_mem = 64
            break
    print "#writting to recommend.txt"
